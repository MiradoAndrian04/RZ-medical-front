...
const Login = () => {
  ...
  return (
    <div className="bg-[url('/img/bg-medical.jpg')] bg-no-repeat bg-cover bg-right h-screen flex justify-center items-center">
      <div className="w-full max-w-md backdrop-blur-md max-sm:h-full  p-10 rounded-lg shadow-2xl text-white">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-blue opacity-60 hover:opacity-80  py-3 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300"
          >
