    ...
    <div className="flex flex-col w-full h-[680px]">
      ...
      <div className="flex flex-row mt-3">
        <div className="flex flex-row w-[70%] h-[400px] ml-32">
          <ProduitCard src="../../public/img/gants-nitrile-chirurgicaux.png" />
          <div className="flex flex-col flex-wrap w-[65%] h-[385px] ml-5 mt-3">
            ...
            <br />
            <br />
            <p className="flex text-2xl font-semibold justify-end">
              Prix : 5.000 Ar
            </p>
          </div>
        </div>
        <div className="flex flex-col w-[30%] h-[500px] ml-11">
          <div className="w-[95%] h-10 mx-3">
            <input
              ...
              className="w-full h-10 rounded-full pl-3 border-2 border-gray"
            />
          </div>
          <div className="w-[80%] h-[310px] border-[1px] border-gray ml-11 mt-7">
            ...
            <div>
              <ul className="w-full">
                <a
                  href="#"
                  className="flex w-full py-5 justify-center hover:bg-lightblue"
                >
